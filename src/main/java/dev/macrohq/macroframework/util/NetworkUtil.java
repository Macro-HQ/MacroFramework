...
public final class NetworkUtil {
     ...
     * @param url The URL to read.
     * @return The contents of the URL.
     * @see NetworkUtil#getString(String, String, int, boolean)
     */
     ...
     * @return The contents of the URL.
     * @see NetworkUtil#getString(String, String, int, boolean)
     * @see JsonUtil#parseString(String)
     */
    public static JsonElement getJsonElement(String url, String userAgent, int timeout, boolean useCaches) {
        return JsonUtil.parseString(getString(url, userAgent, timeout, useCaches));
    }
     ...
     * @param url The URL to read.
     * @return The contents of the URL.
     * @see NetworkUtil#getJsonElement(String, String, int, boolean)
     */
     ...
     * @param file The file to download to.
     * @return Whether the download was successful.
     * @see NetworkUtil#downloadFile(String, File, String, int, boolean)
     */
